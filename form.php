...
<body>
    ...
    <form action="thanks.php" method="POST">
        <div class="form-label-input">
            ...
            <input type="text" id="lastname" name="user_lastname" size="32">
        </div>
        <div class="form-label-input">
            <label for="firstname">Prénom :</label>
            <input type="text" id="firstname" name="user_firstname" size="32">
        </div>
        <div class="form-label-input">
            <label for="mail">E-mail&nbsp;:</label>
            <input type="email" id="mail" name="user_mail" size="32">
        </div>
        <div class="form-label-input">
            <label for="tel">Téléphone&nbsp;:</label>
            <input type="tel" id="tel" name="user_tel" size="32">
        </div>
        <div class="form-label-input">
